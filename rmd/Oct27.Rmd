...
result <- nlm(f=ridge_obj, p = init_r, iterlim =2000, print.level = 0, data=s5, penalties = list("r"=20), loss_func = rmse_loss, smooth_func = r_smooth_c1, pen_func = log, iwt = s5_iwt)
```
